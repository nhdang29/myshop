...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  bool _isValidImageUrl(String value){
    return (value.startsWith('http')||value.startsWith('https')  && (value.endsWith('.png'))
  ...
  buildPriceField() {
    return TextFormField(
      ...
      validator: (value){
        ...
        if(double.tryParse(value)! <= 0) return 'Please enter a number greater than zero';
        return null;
      },
      onSaved: (value){
  ...
  buildImageURLField() {
    return TextFormField(
      ...
      validator: (value){
        ...
        if(!_isValidImageUrl(value)) return 'Please enter a valid image URL';
        return null;
      },
      onSaved: (value){
